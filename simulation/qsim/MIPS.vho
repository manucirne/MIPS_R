...
-- Equation(s):
-- \mips_r|pc|REGISTRADOR|saida[3]~5_combout\ = (\mips_r|pc|REGISTRADOR|saida\(2) & (\mips_r|pc|REGISTRADOR|saida\(3) $ (VCC))) # (!\mips_r|pc|REGISTRADOR|saida\(2) & (\mips_r|pc|REGISTRADOR|saida\(3) & VCC))
-- \mips_r|pc|REGISTRADOR|saida[3]~6\ = CARRY((\mips_r|pc|REGISTRADOR|saida\(2) & \mips_r|pc|REGISTRADOR|saida\(3)))
...
PORT MAP (
	dataa => \mips_r|pc|REGISTRADOR|saida\(2),
	datab => \mips_r|pc|REGISTRADOR|saida\(3),
	datad => VCC,
...
-- Equation(s):
-- \mips_r|pc|REGISTRADOR|saida[7]~13_combout\ = \mips_r|pc|REGISTRADOR|saida\(7) $ (!\mips_r|pc|REGISTRADOR|saida[6]~12\)
...
-- Equation(s):
-- \mips_r|rom|memROM~2_combout\ = (!\mips_r|pc|REGISTRADOR|saida\(4) & (!\mips_r|pc|REGISTRADOR|saida\(5) & (!\mips_r|pc|REGISTRADOR|saida\(6) & !\mips_r|pc|REGISTRADOR|saida\(7))))
...
PORT MAP (
	...
	datad => \mips_r|pc|REGISTRADOR|saida\(5),
	combout => \mips_r|rom|memROM~4_combout\);

\mips_r|rom|memROM~10\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|rom|memROM~10_combout\ = (\mips_r|pc|REGISTRADOR|saida\(6)) # ((\mips_r|pc|REGISTRADOR|saida\(7)) # (\mips_r|rom|memROM~4_combout\))
...
PORT MAP (
	dataa => \mips_r|pc|REGISTRADOR|saida\(6),
	datab => \mips_r|pc|REGISTRADOR|saida\(7),
	datac => \mips_r|rom|memROM~4_combout\,
	combout => \mips_r|rom|memROM~10_combout\);

\mips_r|rom|memROM~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|rom|memROM~6_combout\ = (\mips_r|pc|REGISTRADOR|saida\(4)) # ((\mips_r|pc|REGISTRADOR|saida\(5)) # (\mips_r|pc|REGISTRADOR|saida\(2) $ (\mips_r|pc|REGISTRADOR|saida\(3))))
...
-- Equation(s):
-- \mips_r|rom|memROM~5_combout\ = (!\mips_r|pc|REGISTRADOR|saida\(6) & !\mips_r|pc|REGISTRADOR|saida\(7))
...
-- Equation(s):
-- \mips_r|bancoReg|memROM~171_combout\ = (\mips_r|rom|memROM~5_combout\ & (\SW[1]~input_o\ & (!\mips_r|rom|memROM~2_combout\ & !\mips_r|rom|memROM~4_combout\)))
...
-- Equation(s):
-- \mips_r|bancoReg|memROM~172_combout\ = (\SW[1]~input_o\ & (!\mips_r|rom|memROM~2_combout\ & ((\mips_r|rom|memROM~4_combout\) # (!\mips_r|rom|memROM~5_combout\))))
...
PORT MAP (
	dataa => \SW[1]~input_o\,
	datab => \mips_r|rom|memROM~4_combout\,
	datac => \mips_r|rom|memROM~5_combout\,
...
-- Equation(s):
-- \mips_r|ULA|Add0~25_combout\ = (\mips_r|bancoReg|memROM~18_q\ & (!\mips_r|rom|memROM~7_combout\ & ((!\mips_r|rom|memROM~2_combout\) # (!\mips_r|pc|REGISTRADOR|saida\(2)))))
...
-- Equation(s):
-- \mips_r|rom|memROM~8_combout\ = (\mips_r|rom|memROM~2_combout\ & \mips_r|pc|REGISTRADOR|saida\(3))
...
-- Equation(s):
-- \mips_r|ULA|Add0~27_combout\ = (!\mips_r|bancoReg|Equal1~8_combout\ & ((\mips_r|ULA|Add0~24_combout\) # ((\mips_r|ULA|Add0~25_combout\) # (\mips_r|ULA|Add0~26_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~24_combout\,
	datab => \mips_r|ULA|Add0~25_combout\,
	datac => \mips_r|ULA|Add0~26_combout\,
	datad => \mips_r|bancoReg|Equal1~8_combout\,
	combout => \mips_r|ULA|Add0~27_combout\);

\mips_r|rom|memROM~9\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|rom|memROM~9_combout\ = (!\mips_r|pc|REGISTRADOR|saida\(4) & (!\mips_r|pc|REGISTRADOR|saida\(5) & ((\mips_r|pc|REGISTRADOR|saida\(2)) # (\mips_r|pc|REGISTRADOR|saida\(3)))))
...
-- Equation(s):
-- \mips_r|bancoReg|saidaA[2]~0_combout\ = (!\mips_r|pc|REGISTRADOR|saida\(4) & !\mips_r|pc|REGISTRADOR|saida\(5))
...
-- Equation(s):
-- \mips_r|bancoReg|saidaA[2]~1_combout\ = (\mips_r|rom|memROM~5_combout\ & (\mips_r|rom|memROM~9_combout\ & ((!\mips_r|bancoReg|memROM~48_q\) # (!\mips_r|bancoReg|saidaA[2]~0_combout\))))
...
PORT MAP (
	dataa => \mips_r|rom|memROM~5_combout\,
	datab => \mips_r|rom|memROM~9_combout\,
	datac => \mips_r|bancoReg|saidaA[2]~0_combout\,
	datad => \mips_r|bancoReg|memROM~48_q\,
...
-- Equation(s):
-- \mips_r|bancoReg|saidaA[1]~2_combout\ = (\mips_r|rom|memROM~2_combout\ & ((!\mips_r|bancoReg|memROM~47_q\) # (!\mips_r|rom|memROM~9_combout\)))
...
PORT MAP (
	...
	datad => \mips_r|bancoReg|memROM~47_q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~46_combout\,
...
-- Equation(s):
-- \mips_r|bancoReg|saidaA[0]~3_combout\ = (\mips_r|rom|memROM~5_combout\ & (\mips_r|rom|memROM~9_combout\ & ((!\mips_r|bancoReg|memROM~46_q\) # (!\mips_r|bancoReg|saidaA[2]~0_combout\))))
...
PORT MAP (
	...
	datab => \mips_r|rom|memROM~9_combout\,
	datac => \mips_r|bancoReg|saidaA[2]~0_combout\,
	datad => \mips_r|bancoReg|memROM~46_q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~38_combout\,
	datab => \mips_r|bancoReg|saidaA[0]~3_combout\,
	datad => \mips_r|rom|memROM~2_combout\,
...
-- Equation(s):
-- \mips_r|ULA|Add0~33_combout\ = (\mips_r|rom|memROM~3_combout\ & (((!\mips_r|rom|memROM~8_combout\) # (!\mips_r|bancoReg|memROM~41_q\)))) # (!\mips_r|rom|memROM~3_combout\ & (\mips_r|bancoReg|memROM~11_q\ & ((!\mips_r|rom|memROM~8_combout\))))
...
PORT MAP (
	dataa => \mips_r|rom|memROM~3_combout\,
	datab => \mips_r|bancoReg|memROM~11_q\,
	datac => \mips_r|bancoReg|memROM~41_q\,
	datad => \mips_r|rom|memROM~8_combout\,
...
PORT MAP (
	...
	datab => \mips_r|bancoReg|memROM~46_q\,
	datac => \mips_r|bancoReg|memROM~16_q\,
	datad => \mips_r|rom|memROM~3_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~33_combout\,
	datab => \mips_r|ULA|Add0~34_combout\,
	datac => \mips_r|rom|memROM~7_combout\,
	datad => \mips_r|bancoReg|Equal1~8_combout\,
...
PORT MAP (
	dataa => \mips_r|rom|memROM~2_combout\,
	datab => \mips_r|ULA|Add0~40_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|bancoReg|memROM~42_q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|bancoReg|memROM~12_q\,
	datab => \mips_r|bancoReg|memROM~17_q\,
...
-- Equation(s):
-- \mips_r|ULA|Add0~31_combout\ = (\mips_r|rom|memROM~3_combout\ & (\mips_r|ULA|Add0~28_combout\ & (\mips_r|rom|memROM~8_combout\))) # (!\mips_r|rom|memROM~3_combout\ & (((!\mips_r|rom|memROM~8_combout\ & \mips_r|ULA|Add0~30_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~28_combout\,
	datab => \mips_r|rom|memROM~3_combout\,
	datac => \mips_r|rom|memROM~8_combout\,
	datad => \mips_r|ULA|Add0~30_combout\,
	combout => \mips_r|ULA|Add0~31_combout\);

\mips_r|ULA|Add0~32\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|ULA|Add0~32_combout\ = (\mips_r|ULA|Add0~31_combout\ & !\mips_r|bancoReg|Equal1~8_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~31_combout\,
	datad => \mips_r|bancoReg|Equal1~8_combout\,
	combout => \mips_r|ULA|Add0~32_combout\);

\mips_r|ULA|Add0~42\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|ULA|Add0~42_combout\ = (\mips_r|ULA|Add0~27_combout\ & ((\mips_r|bancoReg|saidaA[2]~1_combout\ & (\mips_r|ULA|Add0~41\ & VCC)) # (!\mips_r|bancoReg|saidaA[2]~1_combout\ & (!\mips_r|ULA|Add0~41\)))) # (!\mips_r|ULA|Add0~27_combout\ & 
-- ((\mips_r|bancoReg|saidaA[2]~1_combout\ & (!\mips_r|ULA|Add0~41\)) # (!\mips_r|bancoReg|saidaA[2]~1_combout\ & ((\mips_r|ULA|Add0~41\) # (GND)))))
-- \mips_r|ULA|Add0~43\ = CARRY((\mips_r|ULA|Add0~27_combout\ & (!\mips_r|bancoReg|saidaA[2]~1_combout\ & !\mips_r|ULA|Add0~41\)) # (!\mips_r|ULA|Add0~27_combout\ & ((!\mips_r|ULA|Add0~41\) # (!\mips_r|bancoReg|saidaA[2]~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~27_combout\,
	datab => \mips_r|bancoReg|saidaA[2]~1_combout\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~42_combout\,
	datab => \mips_r|bancoReg|saidaA[2]~1_combout\,
	datad => \mips_r|rom|memROM~2_combout\,
...
-- Equation(s):
-- \mips_r|ULA|Add0~19_combout\ = (\mips_r|pc|REGISTRADOR|saida\(2) & (((!\mips_r|bancoReg|memROM~49_q\)) # (!\mips_r|pc|REGISTRADOR|saida\(3)))) # (!\mips_r|pc|REGISTRADOR|saida\(2) & (!\mips_r|pc|REGISTRADOR|saida\(3) & (\mips_r|bancoReg|memROM~19_q\)))
...
-- Equation(s):
-- \mips_r|ULA|Add0~17_combout\ = (\mips_r|ULA|Add0~19_combout\ & !\mips_r|pc|REGISTRADOR|saida\(6))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~19_combout\,
	datab => \mips_r|pc|REGISTRADOR|saida\(6),
	combout => \mips_r|ULA|Add0~17_combout\);

\mips_r|ULA|Add0~50\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|ULA|Add0~50_combout\ = (\mips_r|ULA|Add0~17_combout\ & (!\mips_r|pc|REGISTRADOR|saida\(7) & (!\mips_r|pc|REGISTRADOR|saida\(4) & !\mips_r|pc|REGISTRADOR|saida\(5))))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~17_combout\,
	datab => \mips_r|pc|REGISTRADOR|saida\(7),
	datac => \mips_r|pc|REGISTRADOR|saida\(4),
	datad => \mips_r|pc|REGISTRADOR|saida\(5),
...
-- Equation(s):
-- \mips_r|bancoReg|saidaA[3]~4_combout\ = (\mips_r|rom|memROM~2_combout\ & (\mips_r|rom|memROM~9_combout\ & \mips_r|bancoReg|memROM~49_q\))
...
PORT MAP (
	dataa => \mips_r|rom|memROM~2_combout\,
	datab => \mips_r|rom|memROM~9_combout\,
	datac => \mips_r|bancoReg|memROM~49_q\,
	combout => \mips_r|bancoReg|saidaA[3]~4_combout\);

\mips_r|ULA|Add0~47\ : cycloneive_lcell_comb
-- Equation(s):
-- \mips_r|ULA|Add0~47_combout\ = \mips_r|ULA|Add0~50_combout\ $ (\mips_r|bancoReg|saidaA[3]~4_combout\ $ (!\mips_r|ULA|Add0~43\))
...
-- pragma translate_on
PORT MAP (
	dataa => \mips_r|ULA|Add0~50_combout\,
...
PORT MAP (
	dataa => \mips_r|rom|memROM~2_combout\,
	datab => \mips_r|ULA|Add0~47_combout\,
	combout => \mips_r|ULA|Add0~49_combout\);

\conv7seg0|rascSaida7seg[0]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \conv7seg0|rascSaida7seg[0]~0_combout\ = (\mips_r|ULA|Add0~44_combout\ & (!\mips_r|ULA|Add0~45_combout\ & (\mips_r|ULA|Add0~46_combout\ $ (!\mips_r|ULA|Add0~49_combout\)))) # (!\mips_r|ULA|Add0~44_combout\ & (\mips_r|ULA|Add0~46_combout\ & 
-- (\mips_r|ULA|Add0~45_combout\ $ (!\mips_r|ULA|Add0~49_combout\))))
...
PORT MAP (
	dataa => \mips_r|ULA|Add0~44_combout\,
	datab => \mips_r|ULA|Add0~45_combout\,
	datac => \mips_r|ULA|Add0~46_combout\,
	datad => \mips_r|ULA|Add0~49_combout\,
	combout => \conv7seg0|rascSaida7seg[0]~0_combout\);

\conv7seg0|rascSaida7seg[1]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \conv7seg0|rascSaida7seg[1]~1_combout\ = (\mips_r|ULA|Add0~45_combout\ & ((\mips_r|ULA|Add0~46_combout\ & (\mips_r|ULA|Add0~49_combout\)) # (!\mips_r|ULA|Add0~46_combout\ & ((\mips_r|ULA|Add0~44_combout\))))) # (!\mips_r|ULA|Add0~45_combout\ & 
-- (\mips_r|ULA|Add0~44_combout\ & (\mips_r|ULA|Add0~49_combout\ $ (\mips_r|ULA|Add0~46_combout\))))
...
PORT MAP (
	...
	datad => \mips_r|ULA|Add0~46_combout\,
	combout => \conv7seg0|rascSaida7seg[1]~1_combout\);

\conv7seg0|rascSaida7seg[2]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \conv7seg0|rascSaida7seg[2]~2_combout\ = (\mips_r|ULA|Add0~44_combout\ & (((\mips_r|ULA|Add0~46_combout\ & !\mips_r|ULA|Add0~45_combout\)) # (!\mips_r|ULA|Add0~49_combout\))) # (!\mips_r|ULA|Add0~44_combout\ & ((\mips_r|ULA|Add0~46_combout\) # 
-- ((\mips_r|ULA|Add0~49_combout\) # (!\mips_r|ULA|Add0~45_combout\))))
...
-- Equation(s):
-- \conv7seg0|rascSaida7seg[3]~3_combout\ = (\mips_r|ULA|Add0~45_combout\ & ((\mips_r|ULA|Add0~44_combout\ & ((\mips_r|ULA|Add0~46_combout\))) # (!\mips_r|ULA|Add0~44_combout\ & (\mips_r|ULA|Add0~49_combout\ & !\mips_r|ULA|Add0~46_combout\)))) # 
...
PORT MAP (
	...
	datab => \mips_r|ULA|Add0~44_combout\,
...
-- Equation(s):
-- \conv7seg0|rascSaida7seg[4]~4_combout\ = (\mips_r|ULA|Add0~45_combout\ & (!\mips_r|ULA|Add0~49_combout\ & (\mips_r|ULA|Add0~46_combout\))) # (!\mips_r|ULA|Add0~45_combout\ & ((\mips_r|ULA|Add0~44_combout\ & (!\mips_r|ULA|Add0~49_combout\)) # 
...
-- Equation(s):
-- \conv7seg0|rascSaida7seg[5]~5_combout\ = (\mips_r|ULA|Add0~46_combout\ & (\mips_r|ULA|Add0~49_combout\ $ (((\mips_r|ULA|Add0~45_combout\) # (!\mips_r|ULA|Add0~44_combout\))))) # (!\mips_r|ULA|Add0~46_combout\ & (!\mips_r|ULA|Add0~44_combout\ & 
-- (\mips_r|ULA|Add0~45_combout\ & !\mips_r|ULA|Add0~49_combout\)))
